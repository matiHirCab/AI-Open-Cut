...
- Compare candidate and post-archive protected workflows with both completed baselines. Under two hours is the PR acceptance target, not an automated assertion. If the 1920x1080 shard prevents that target, leave the change unarchived and seek separately approved renderer optimization.
