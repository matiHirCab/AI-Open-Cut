...
2. **Determine the workflow schema**
   ...
   **Use a different schema only if the user mentions:**
   ...
   - "show workflows" or "what workflows" → run `bunx @fission-ai/openspec@1.5.0 schemas --json` and let them choose
...
5. **Get instructions for the first artifact**
   ...
   ```bash
   bunx @fission-ai/openspec@1.5.0 instructions <first-artifact-id> --change "<name>"
   ```
