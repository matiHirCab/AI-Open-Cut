...
1. **Select the change**
   ...
   - If ambiguous, run `bunx @fission-ai/openspec@1.5.0 list --json` to get available changes and ask the user to select
...
3. **Get apply instructions**
   ...
   ```bash
   bunx @fission-ai/openspec@1.5.0 instructions apply --change "<name>" --json
   ```
